                        ...
                        <tbody>
                            <tr>
                                <?php foreach ($listado as $fila) { ?>
                                    <td><?php echo $fila['id_interaccion'] ?> </td>
                                    ...
                                    <td><?php if ($fila['megusta'] == 1) {
                                            echo 'Like';
                                        } else {
                                            echo utf8_decode($fila['comentarios']);
                                        } ?> </td>



                                    <td>
                                        <button class="btn btn-success btn-sm edit" data-id="<?php echo $fila['id_interaccion'] ?>">
                                            <i class="fas fa-pen" aria-hidden="true"></i>
                                        </button>
                                        <button class="btn btn-danger btn-sm delete" data-id="<?php echo $fila['id_interaccion'] ?>">
